...
//
$all_admin_apps = get_all_admin_apps();
?>
                ...
                <div class="list-group">
                    ...
                    foreach ($all_admin_apps as &$admin_app) {
                        ...
                        <div class="list-group-item">
                            <h4 class="list-group-item-heading"><?php echo $admin_app->name; ?></h4>
                            <p class="list-group-item-text"><?php echo $admin_app->description; ?></p>
                            <a id="<?php echo $admin_app->id; ?>" href="#"
